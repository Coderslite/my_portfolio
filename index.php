...
<!-- Mirrored from avstechnolabs.com/Themeforest/Gaspar/01/Dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jun 2022 23:46:41 GMT -->
<head>
  <!-- Title of The Page -->
  <title>Coderslite | Personal Portfolio</title>
  <!-- Meta Informations -->
  <meta charset="utf-8">
  <meta name="description" content="Coderslite | Personal Portfolio">
  <meta name="keywords" content="Coderslite, Abraham Great">
  <meta name="author" content="Coderslite, Abraham Great">
  ...
  <div class="gaspar" data-magic-cursor="show" data-color="crimson">
    ...
    <h4>Light Mode</h4>
        <div class="switch" id="switcherrr">
          <a href="https://avstechnolabs.com/Themeforest/Gaspar/01/Light/index.html"><i class="fas fa-sun open"></i></a>
        </div>
            ...
            <div class="row align-items-center">
              ...
              <div class=" col-xl-5 col-lg-6 col-md-6 col-12">
                <div class="home-profile animate__animated animate__fadeInLeft animate__delay-1s">
                  <img src="assets/images/profile/ab.jpg" alt="home-profile">
                </div>
              </div>
              <!-- Profile-Pic End-->
              <!-- Profile-Information -->
              <div class="col-xl-7 col-lg-6 col-md-6 col-12">
                <div class="home-content">
                  ...
                  <h1 class="common-title animate__animated animate__fadeInDown animate__delay-1s">Abraham Great</h1>
                  ...
                  <p class="lorem-text animate__animated animate__zoomIn animate__delay-2-5s">I am a freelancer based in
                    the
                    Nigeria and i have been building noteworthy
                    UX/UI designs and websites and cross platform mobile applications for years, which comply with the latest design trends. I help convert a
            ...
            <div class="about-content">
                ...
                <div class="col-lg-4 profile-photo animate__animated animate__fadeInLeft animate__delay-2s ">
                  <div class="row">
                    <div class="col-12 d-block col-sm-none">
                      <img src="assets/images/profile/ab.jpg" class="img-fluid main-img-mobile" alt="my picture">
                    </div>
                  </div>
                </div>
                <div class="col-lg-8 col-sm-12">
                  <div class="row personal-info animate__animated animate__fadeInRight animate__delay-2s">
                    ...
                    <div class="col-12">
                      ...
                      <h3 class="personal-title">I'm Abraham Great, a visual <span>UX/UI Designer</span> and <span>Web
                          Developer</span> and <span>Mobile App Developer</span></h3>
                      <p class="info">I am a freelancer based in the Nigeria and i have been building noteworthy
                        UX/UI designs and websites and cross platform mobile applications  for years, which comply with the latest design trends. I help convert
                        a
                        vision and an idea into meaningful and useful products. Having a sharp eye for product evolution
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-lg-6">
                        <ul class="about-you ">
                          ...
                          <li>
                            ...
                            <span class="value">31 Oyo Efam Street Calabar, Cross River State, Nigeria.</span>
                          </li>
                          <li>
                            <span class="title">From :</span>
                            <span class="value">Delta State, Nigeria</span>
                          </li>
                          <li>
                      ...
                      <div class="col-lg-6">
                        <ul class="about-you ">
                          <li>
                            ...
                            <span class="value"><a href="mailto:abrahamgreatebele@gmail.com">abrahamgreatebele@gmail.com</a></span>
                          </li>
                          <li>
                            <span class="title">Phone :</span>
                            <span class="value"><a href="tel:+2348145108521">(+234) 814-510-8521</a></span>
                          </li>
                          <!-- <li>
                      ...
                      <div class="col-lg-12">
                        <div class="About-btn">
                          <a href="files/resume.pdf" target="_blank" class="clickbtn download-cv">Download CV <i class="fa fa-download"
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-12 ">
                    <div class=" col-block education ">
                      ...
                      <div class="resume-item"><span class="item-arrow"></span>
                        <h5 class="item-title">Bachelor of Science in Computer Science</h5><span
                          class="item-details">University of Cross River State/ 2018 - 2022</span>
                        <p class="item-description">I graduated from University of Cross River State with 3.69 GPA. in Computer Science department</p>
                      </div>
                      <!-- <div class="resume-item"><span class="item-arrow"></span>
                  ...
                  <div class="col-md-6 col-12 ">
                    <div class=" col-block education">
                      ...
                      <div class="resume-item"><span class="item-arrow"></span>
                        <h5 class="item-title">Lead Program Manager </h5><span class="item-details">Google Student Club/ 2021 -
                          2022</span>
                        <!-- <p class="item-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio quo
                          repudiandae.</p> -->
                      </div>
                      <div class="resume-item"><span class="item-arrow"></span>
                        <h5 class="item-title">Co-founder Cortex Technology</h5><span class="item-details">Adobe / 2019 -
                          till now</span>
                        <!-- <p class="item-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio quo
                          repudiandae.</p> -->
                      </div>
                      <div class="resume-item"><span class="item-arrow"></span>
                        <h5 class="item-title">FindCribs Mobile Developer</h5><span class="item-details">2022 - till now</span>
                        <!-- <p class="item-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio quo
                          repudiandae.</p> -->
                      </div>
                    </div>
              ...
              <div class="services-section text-center ">
                <div class="row ">
                  <div class="col-12">
                    ...
                    <p class="service-text">I am a full stack Software Developer, i build responsive and modern web applications and mobile applications for my clients<br>
                    </p>
                  </div>
                </div>
                <div class="row animate__animated animate__zoomIn animate__slower animate__delay-3s">
                  ...
                  <div
                    ...
                    <div class="service-item">
                      ...
                      <p>
                       I develop responsive web applications using Bootstrap, React js, Next Js, Tailwind css..
                      </p>
                    </div>
                  </div>
                  <!-- End Single Item -->
                  ...
                  <div
                    ...
                    <div class="service-item">
                      ...
                      <h4><span class="service-line">Mobile App Develoment</span></h4>
                      <p>
                        I build modern cross platform applications using flutter/dart, react native, firebase, node js,PHP...
                      </p>
                    </div>
                  </div>
                  <!-- End Single Item -->
                  ...
                  <div
                    ...
                    <div class="service-item">
                      ...
                      <p>
                       Get cool modern designs and prototype of your desired web or mobile applications
                      </p>
                    </div>
                  </div>
                  <!-- End Single Item -->
                  ...
                  <div
                    ...
                    <div class="service-item">
                      ...
                      <h4><span class="service-line">Software Management / Maintenance</span></h4>
                      <p>
                        Using system development life cycle, i can help you in managing your software to satisfy the end-users needs
                      </p>
                    </div>
                  </div>
                  <!-- End Single Item -->
                ...
                <div id="testimonial" class="owl-carousel owl-theme">
                  <div class="item">
                    <div class="testimonial-item">
                      ...
                      <p>Thank you Mr Abraham, i can attest your credibility in software development.</p>
                      <div class="rating">
                  ...
                  <div class="item">
                    <div class="testimonial-item">
                      ...
                      <p>Mr Abraham is a strong software engineer, he has helped me in actucalizing my dream software to reality</p>
                      <div class="rating">
                        <i class="fas fa-3x fa-star"></i>
                        <i class="fas fa-3x fa-star"></i>
                        <i class="fas fa-3x fa-star"></i>
                  ...
                  <div class="item">
                    <div class="testimonial-item">
                      ...
                      <p>Thanks buddy, real estate app working perfectly</p>
                      <div class="rating">
                        <i class="fas fa-3x fa-star"></i>
                        <i class="fas fa-3x fa-star"></i>
                        <i class="fas fa-3x fa-star"></i>
                  ...
                  <div class="item">
                    <div class="testimonial-item">
                      ...
                      <p>You won my trust gee.. Thanks you</p>
                      <div class="rating">
                        <i class="fas fa-3x fa-star"></i>
                        <i class="fas fa-3x fa-star"></i>
                        <i class="fas fa-3x fa-star"></i>
                  ...
                  <div class="item">
                    <div class="testimonial-item">
                      ...
                      <p>I Worked with Mr Abraham and i can attest his friendly and understandable with cool knowledge of software development and SDLC</p>
                      <div class="rating">
                        <i class="fas fa-3x fa-star"></i>
                        <i class="fas fa-3x fa-star"></i>
                        <i class="fas fa-3x fa-star"></i>
              ...
              <div class="funfacts-section">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div class="funfacts-box">
                      <h3 class="counter" data-to="15" data-time="100000">0</h3>
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div class="funfacts-box">
                      <h3 class="counter" data-to="5" data-time="10000">0</h3>
                  ...
                  <div class="portfolio-menu animate__animated animate__fadeInUp animate__delay-2s">
                    <nav class="controls ">
                      ...
                      <button type="button" class="control clickbtn"
                        data-filter=".webdevelopment ">Web Development</button>
                      <button type="button" class="control clickbtn" data-filter=".mobiledev ">Mobile Development</button>
              ...
              <div class="row portfolio-list animate__zoomIn animate__animated animate__delay-3s">
                <div class="container">
                  <ul class="row ps-0">
                    ...
                    <!-- Mix Content-Box -->
                    <li class="mix mobiledev col-xl-3 col-lg-4 col-md-6">
                        ...
                        <li>
                          <div class="media d-flex align-items-center"><span class="info-icon"><i
                            ...
                            <div class="media-body info-details">
                              <h6 class="info-type">Name</h6><span class="info-value">Abraham Great</span>
                            </div>
                          </div>
                        </li>
                        <li>
                          <div class="media d-flex align-items-center"><span class="info-icon"><i
                            ...
                            <div class="media-body info-details">
                              <h6 class="info-type">Location</h6><span class="info-value">31 Oyo Street Calabar, Cross River State, Nigeria.</span>
                            </div>
                          </div>
                        </li>
                        <li>
                          <div class="media d-flex align-items-center"><span class="info-icon"><i
                            ...
                            <div class="media-body info-details">
                              <h6 class="info-type">Call Me</h6><span class="info-value"><a href="tel:+2348145108521">+234-814-510-8521</a></span>
                            </div>
                          </div>
                        </li>
                        <li>
                          <div class="media d-flex align-items-center"><span class="info-icon"><i
                            ...
                            <div class="media-body info-details">
                              <h6 class="info-type">Email Me</h6><span class="info-value"><a
                                  href="mailto:Abrahamgreatebele@gmail.com">Abrahamgreatebele@gmail.com</a></span>
                            </div>
                          </div>
                        </li>
                      </ul>
...
<!-- Mirrored from avstechnolabs.com/Themeforest/Gaspar/01/Dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jun 2022 23:47:29 GMT -->
</html>